...
# Get the URL of the ISM manifest.xml file as a command line argument
parser = argparse.ArgumentParser(description='Download a PlayReady protected video.')
parser.add_argument('url', metavar='URL', type=str, help='URL of the ISM manifest.xml file')
...
# Parse the manifest.xml file with ElementTree
